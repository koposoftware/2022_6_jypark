...
② 카드사는 카드이용대금에 우선하여 연회비를 청구할 수 있으며, 연회비는 카드발급 시점을 기준으로 원칙적으로1년 단위로 청구됩니다. 다만, 다음 각호의 요건을 모두 충족하는 경우 월납 등 분납 청구도 가능합니다.
...
① 회원이 유효기한이 도래하기 전에 카드를 해지하는 경우 연회비 반환금액은 회원이 카드사와 계약을 해지한 날부터 일할 계산(회원의 카드이용이 가능하게 된 날을 기준으로 계산한다)하여 산정합니다. 이 경우 회원이 이미 납부한 연회비에 반영된 다음 각 호의 비용은 반환금액 산정에서 제외됩니다.
...
제7조(카드이용 정지)
① 카드사는 회원이 다음 각 호에 해당하는 경우 회원의 카드이용을 정지할 수 있으며, 제7호를 제외한 나머지 사유로 이용 정지하는 경우에는 휴대폰 메시지 또는 전화로 이용 정지 예정사실을 회원에게 미리 알려드립니다(카드사가 과실 없이 회원의 휴대폰 번호를 알지 못하거나, 통신사의 사정 등에 따라 휴대폰 메시지가 전송되지 않을 경우에는 이용 정지 당일에 전자우편(E-MAIL)으로 통지하거나 서면으로 발송). 다만, 제6호의 경우에는 사전 고지 없이 카드이용이 정지될 수 있습니다(사유 발생 당일 고지).
...
③ 회원은 카드사에 대하여 카드사용의 일시정지를 요청할 수 있으며 카드사는 회원이 서면, 전화, 인터넷 홈페이지 등을 통하여 카드 사용의 일시정지를 할 수 있도록 합니다. 카드사는 회원의 요청에 따라 카드 사용이 정지된 이후 해외에서 카드사의 승인 없이 전표가 매입되는 거래(이하 “해외 무승인매입”이라 한다)가 발생한 경우 매출전표가 매입된 날로부터 3영업일 이내에 회원에게 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX) 중 1가지 이상의 방법으로 해외 무승인매입에 따른 카드이용대금 청구예정 사실을 안내하여 드립니다.
④ 카드사는 회원의 카드이용 정지 상태가 해소되는 경우 사유 발생 당일에 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX) 중 1가지 이상의 방법으로 회원에게 알려드립니다.
제7조의2(카드의 한도감액)
카드사는 회원이 다음 각 호에 해당하는 경우 회원의 이용한도를 감액할 수 있으며, 이 경우 휴대폰 메시지 또는 전화로 한도감액 예정사실을 회원에게 미리 알려드립니다(카드사가 과실 없이 회원의 휴대폰 번호를 알지 못하거나, 통신사의 사정 등에 따라 휴대폰 메시지가 전송되지 않을 경우에는 한도감액 당일에 전자우편(E-MAIL)으로 통지하거나 서면으로 발송). 다만, 제5호의 경우에는 사전 고지 없이 이용한도가 감액될 수 있습니다(사유 발생 당일 고지).
...
③ 제1항 내지 제2항의 사유로 카드이용계약이 해지된 경우에는 회원은 즉시 카드를 반납하고, 카드사는 그날까지의 채무 전액 변제를 요구할 수 있습니다.
...
⑤ 제3항에 따라 이용정지된 신용카드는 유효기간 종료 시 갱신하거나 대체발급할 수 없으며, 이용 정지 상태에서 카드가 부정사용됨으로 인해 회원이 피해를 입을 경우의 책임은 카드사가 부담하고, 이에 대한 입증책임 또한 카드사가 부담합니다.
제 3 장 카드의 이용
제8조(카드의 이용 등)
...
④ 제2항에 따라 이용한도를 감액하는 경우 회원이 요청하는 경우를 제외하고 적용예정일로부터 14일 이전에 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX), 이용대금명세서 중 2가지 이상의 방법으로 통지하여 드립니다.
...
제12조(할부철회권)
① 회원은 할부계약서를 교부받은 날 또는 계약서를 교부받지 않은 경우에는 상품 또는 서비스를 제공받은 날부터 7일 이내에 할부계약을 철회할 수 있습니다. 다만, 다음 각 호의 1에 해당하는 경우 회원은 할부철회권을 행사할 수 없습니다.
...
4. 회원의 책임있는 사유로 해당 상품이 멸실 또는 훼손된 경우
5. 회원이 상행위를 위하여 상품 또는 서비스를 구매한 경우
6. 일부결제금액이월약정(리볼빙) 이용금액
...
⑥ 카드사가 부가서비스를 변경하는 경우 변경사유, 변경 내용 등을 다음 각 호에서 정하는 기간에 따라 서면교부, 우편 또는 전자우편, 전화 또는 팩스, 휴대폰 메시지 또는 이에 준하는 전자적 의사표시 중 2가지 이상의 방법으로 고지하여 드립니다. 다만, 제2호의 경우 부가서비스 변경일 6개월 이전부터는 서면교부, 우편 또는 전자우편, 전화 또는 팩스, 휴대폰 메시지 또는 이에 준하는 전자적 의사표시 중 2가지 이상의 방법으로 매월 고지하여 드립니다.
...
제18조(이용계약의 성립)
① 장기카드대출(카드론) 이용계약은 장기카드대출(카드론) 이용에 동의한 회원이 장기카드대출(카드론)을 신청하고 카드사가 이를 승낙함으로써 성립합니다.
② 카드사는 이자율, 대출기간, 상환방법 등 대출의 주요 내용과 신용변동 가능성을 대출 실행 이전에 회원이 이해할 수 있는 방법으로 설명합니다.
③ 장기카드대출(카드론) 이용계약 성립 이후 카드사는 이자율, 대출기간, 상환방법 등 대출의 주요내용이 포함된 계약서류를 제공하여야 합니다.
제19조(장기카드대출(카드론) 신청 및 상환방식의 결정)
① 회원은 다음 각 호의 하나에 해당하는 방법으로 본인확인절차를 거쳐 장기카드대출(카드론)을 신청할 수 있습니다.
1. 카드사의 본·지점 또는 카드사와 제휴 또는 위임한 기관의 본·지점 방문 : 신분증 제출
2. 카드사가 별도로 정하는 자동음성응답시스템(ARS), 고객센터상담원 : 회원 본인의 고유식별정보 또는 카드번호와 비밀번호를 입력하거나 회원 개인정보(명세서 수령 주소, 휴대폰 번호 등)를 통한 본인확인
3. 인터넷, 모바일 : ID번호와 비밀번호 입력 또는 「전자서명법」 제2조제2호(서명자의 실지명의를 확인할 수 있는 것을 말한다)에 따른 전자서명이 있는 전자문서에 의한 동의 또는 본인 확인의 안정성과 신뢰성이 확보될 수 있는 수단에 의한 동의
4. 자동화기기 : 회원의 카드를 실물 투입 또는 리더기를 통과하거나 제3호에 정한 방법으로 본인확인절차를 거쳐 휴대폰을 통하여 받은 일회성 비밀번호를 자동화기기에 입력하는 방식 등 카드사가 별도로 정하는 방식으로 인증하고 회원의 비밀번호 입력(이 경우 회원은 기기 이용수수료를 부담)
...
① 카드사는 장기카드대출(카드론) 이용에 동의한 회원에 대하여 가처분 소득, 장기카드대출(카드론) 이용기간, 신용상태 등을 고려하여 카드사의 내부기준에 따라 장기카드대출(카드론) 대출가능금액을 부여합니다.
② 카드사는 제1항에 따른 장기카드대출(카드론) 대출가능금액을 부여하는 경우 장기카드대출(카드론) 월 채무원리금 상환액이 장기카드대출(카드론) 이용신청일 이전 회원의 3개월 평균 카드 이용가능한도 미사용금액 이내에서 장기카드대출(카드론) 대출가능금액을 산정합니다.
③ 회원은 카드사가 산정한 장기카드대출(카드론) 대출가능금액 범위 내에서 장기카드대출(카드론)을 이용할 수 있습니다.
제21조(대출금 상환)
...
① 장기카드대출(카드론) 이자·수수료 등(이하 “이자 등”이라고 합니다)의 율·계산방법·지급의 시기 및 방법에 관해 카드사는 법령이 허용하는 한도 내에서 정할 수 있으며, 약정 체결 후에는 변경할 수 없음을 원칙으로 합니다. 다만, 채무이행완료 전에 국가경제·금융사정의 급격한 변동 등으로 계약 당시에 예상할 수 없는 현저한 사정변경이 생긴 때에는 카드사는 회원에 대한 개별통지에 의하여 그 율을 인상·인하할 수 있습니다. 이 경우 변경요인이 해결되어 없어지는 때에는 카드사는 해결되어 없어진 상황에 일치하도록 변경하여야 합니다.
...
③ 카드사는 금리인하요구자의 신용상태 개선이 금리 산정에 영향을 미치는지 여부 등을 고려하여 수용 여부를 판단하며, 다음 각 호의 경우 금리인하 요구를 수용하지 않을 수 있습니다.
1. 계약체결시 회원의 신용상태가 금리 산정에 영향을 미치지 않은 경우
...
제28조(자동이체결제)
① 카드사는 회원의 카드이용대금을 제27조의 결제일에 자동이체결제계좌(단, 통장분실/도난 기타의 사유로 계좌가 변경될 경우에는 변경 후의 계좌)에서 예금통장, 지급청구서 없이 자동으로 인출하여 결제할 수 있습니다.
...
⑤ 제27조제1항의 카드이용대금 결제일이 토요일 또는 공휴일인 경우에는 카드이용대금 결제일 이후 최초 도래하는 은행 영업일에 처리합니다.
제29조(기한이익의 상실)
① 회원에게 다음 각 호에서 정한 사유 중 하나라도 발생한 경우에는 회원은 당연히 카드사에 대한 모든 채무의 기한의 이익을 상실하여 곧 이를 갚아야 할 의무를 집니다. 이 경우, 카드사는 회원에게 서면으로 다음 각 호의 사유 및 이에 따라 다음 각 호의 사유발생 즉시 기한의 이익을 상실하였다는 사실을 함께 통지하여야 합니다.
1. 사망으로 회원의 채무 변제가 불가능한 경우 (90일까지는 지연배상금 미부과)
2. 생업에 종사하기 위하여 또는 외국인과의 결혼, 연고관계, 기타 사유 등으로 인하여 외국으로 이주하는 경우
3. 파산, 개인회생절차 개시의 신청이 있거나, 채무불이행자 명부 등재 신청이 있는 경우
② 회원에게 다음 각 호에서 정한 사유 중 하나라도 발생한 경우에는 당연히 당해채무의 기한의 이익을 상실하며, 회원은 곧 이를 갚아야 할 의무를 집니다. 이 경우, 카드사는 기한이익 상실일 7영업일 전까지 다음 각호의 채무이행 지체사실과 이에 따라 기한의 이익이 상실된다는 사실을 회원에게 서면으로 통지하여야 하며, 기한이익의 상실일 7영업일 전까지 통지하지 않은 경우 회원은 실제 통지가 도달한 날로부터 7영업일이 경과한 날에 기한의 이익이 상실되어 곧 이를 갚아야 할 의무를 집니다.
1. 할부금을 연속하여 2회 이상 지급하지 아니하고, 그 지급하지 아니한 금액이 총 할부금액의 10분의 1을 초과하는 경우
2. 일부결제금액이월약정(리볼빙)의 최소결제금액을 연속하여 2회차 이상 결제하지 않는 경우
3. 장기카드대출(카드론) 이자(원금분할상환 또는 원리금분할상환 형식 제외)를 지급하여야 할 때부터 1개월간 지체한 경우
4. 장기카드대출(카드론) 분할상환금 또는 분할상환원리금의 지급을 2회 이상 연속하여 지체한 경우
5. 회원의 고의·중과실로 카드에 의한 거래가 부정사용 또는 비정상적 거래로 확인된 경우
...
② 카드사는 회원과 일부결제금액이월약정(리볼빙) 체결시 수수료율, 최소결제비율 및 약정결제비율, 일시상환 방법 등 주요 내용과 일부결제금액이월약정(리볼빙)을 이용하여 잔액이 발생한 경우 신용도가 하락할 수 있음을 회원이 이해할 수 있는 방법으로 설명하고, 약정체결 후 여신금융협회의 일부결제금액이월약정(리볼빙) 안내문을 회원에게 교부합니다.
③ 회원의 일부결제금액이월약정(리볼빙) 체결 이후 카드사는 수수료율, 최소결제비율 및 약정결제비율 등의 내용에 대해 서면, 전화, 전자우편(E-MAIL), 이용대금명세서, 휴대폰 메시지 등 회원과 협의한 2가지 이상의 방법으로 통지하여 드립니다.
④ 카드사는 회원의 일부결제금액이월약정(리볼빙) 이용에 따라 잔액이 발생한 경우 카드이용 대금명세서 등을 통해 추가적인 카드이용이 없다는 가정 하에 약정(최소)결제비율에 따라 상환을 완료할 때까지 걸리는 기간(수수료가 부과되는 첫 번째 월부터 상환이 완료되는 마지막 월을 포함하여 개월수로 표시), 총 수수료금액(해당 회원에게 적용한 최근 월의 수수료율을 적용), 총 원금잔액(총 이월잔액)에 대해 별도로 안내합니다.
...
제34조(약정기간)
① 일부결제금액이월약정(리볼빙)은 회원이 이용을 신청한 시점부터 해당 카드의 유효기간까지 이용(최장 5년)할 수 있습니다. 이 경우 카드사는 일부결제금액이월약정(리볼빙)을 실제로 이용하지 않고 약정만 체결한 회원에 대해 12개월마다 동 약정을 해지할 수 있고 해지에 따른 불이익이 없음을 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX), 이용대금명세서 중 2가지이상의 방법으로 안내하여야 하며 안내 시 회원이 인터넷 홈페이지 등을 통해 간편하게 해지할 수 있도록 서비스를 제공합니다. 약정이 연장된 경우에도 같습니다.
② 카드사는 약정기간이 도래한 회원에 대하여 약정기간 만료일로부터 1개월 이전에 약정기간 만료 예정사실[일부결제금액이월약정(리볼빙) 연장가능 회원의 경우에는 일부결제금액이월약정(리볼빙)의 연장 예정 사실 및 연장기간 포함], 수수료율 등 주요 내용을 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX), 이용대금명세서 중 2가지 이상의 방법으로 개별 통보합니다.
...
④ 제3항의 경우 카드사는 회원에게 일부결제금액이월약정(리볼빙)으로 전환된 이월금액 및 선결제 가능 사실을 휴대폰 메시지 또는 전화 등으로 고지합니다.
...
제38조(계약해지)
① 회원이 다음 각 호에 해당하는 경우 일부결제금액이월약정(리볼빙) 이용계약이 해지됩니다.
1. 회원의 계약해지 요청
2. 회원의 탈회 또는 갱신 탈락 등의 경우
3. 제29조(기한이익의 상실)에 해당하는 경우
② 제1항에 해당하는 경우 카드사는 회원에게 이용금액의 전액을 청구할 수 있고 회원은 카드사의 청구를 받은 즉시 결제하여야 합니다.
제7장 카드부정사용 등에 대한 회원의 책임
제39조(카드이용대금에 대한 이의신청 및 책임)
...
③ 회원이 카드사의 조사결과에 이의가 있는 경우에는 조사결과를 통지받은 날로부터 7일 이내에 금융감독원에 조정을 요청할 수 있고, 금융감독원의 분쟁조정이 완료될 때까지 이용대금을 지급하지 않을 수 있습니다. 이때 카드사는 분쟁이 있는 금액의 연체를 이유로 회원의 연체정보를 신용정보집중기관 등에 등록할 수 없습니다.
...
제47조(변경승인 등)
① 이 약관을 변경할 경우 카드사는 그 내용을 변경약관 시행일로부터 1개월 이전까지 회원에게 서면, 전자우편(E-MAIL), 휴대폰 메시지, 이용대금명세서 중 1가지 이상의 방법으로 개별 통지하여 드립니다. 다만, 다음 각 호의 어느 하나에 해당하는 경우에는 변경된 약관을 즉시 통지하여 드립니다.
...
② 카드사는 다음 각 호의 사항을 회원에게 변경예정일로부터 1개월 이전 (제1항제1호의 경우에는 즉시) 까지 홈페이지 게시, 서면, 전화, 전자우편(E-MAIL), 휴대폰 메시지, 팩스(FAX), 이용대금명세서 중 2가지 이상의 방법으로 사전에 알려드립니다. 다만, 제4호의 경우에는 3개월 이전부터 매월 알려드립니다.
1. 카드사가 할부수수료율, 단기카드대출(현금서비스)수수료율, 일부결제금액이월약정(리볼빙) 수수료율, 연체이자율 등 각종 요율 또는 연회비를 인상할 경우
2. 카드사가 일부결제금액이월약정(리볼빙)의 최소결제비율을 변경할 경우
3. 카드사가 결제방법, 할부기간 및 횟수 등을 변경할 경우
4. 신용공여기간을 변경할 경우
③ 제2항제2호의 경우 카드사는 제2항의 방법 이외의 전화 등으로 회원에게 안내가 가능합니다.
④ 제2항제3호 내지 제4호의 경우 카드사는 회원에게 개별 통지 및 변경예정일까지 전국적으로 보급되는 일간신문에 공고 또는 카드사와 제휴사의 본·지점에 게시하는 방법을 병행합니다.
...
② 제7조제1항 및 제7조의2에 따라 카드이용 정지 및 이용한도 감액에 대한 사전 통지는 2016년 11월 1일부터 적용합니다.
③ 제15조제3항의 포인트 사용비율 제한 금지는 2017년 1월 1일부터 신규 출시되는 상품에 적용합니다.
④ 제15조제4항제3호의 부가서비스 유지기간은 2016년 1월 31일부터 최초로 출시되는 부가서비스에 적용합니다.
⑤ 제15조제8항은 2016년 10월 1일부터 적용합니다.
⑥ 제47조제6항은 2017년 1월 1일부터 신규 가입한 회원에게 적용합니다.
⑦ 제7조의4는 이 약관 시행일 이후 휴면카드 사유로 회원에게 계약 해지 또는 유지 의사를 확인하는 건부터 적용합니다.
⑧ 제15조의2는 2018년 12월 31일부터 적용합니다.
⑨ 제32조 제4항, 제34조 제1항은 2018년 12월 1일부터 적용합니다.
⑩ 제3조의2제3항은 2021년 3월 1일부터 신규 출시되는 상품부터 적용합니다.
⑪ 제7조의4제4항은 이 약관 시행일 이후 휴면카드 사유로 이용정지가 된 건부터 적용합니다.
⑫ 제14조제1항은 2021년 3월 1일부터 신규 가입한 회원부터 적용합니다.
⑬ 제15조제10항은 2021년 10월 1일부터 신규 출시되는 상품부터 적용합니다.
⑭ 제24조제2항은 2021년 1월 29일부터 적용합니다.
⑮ 제34조제1항, 제34조제2항, 제34조제3항은 2021년 3월 1일부터 적용합니다.
⑯ 제7조의4제1항 및 제2항의 ‘전자문서’ 추가는 2021년 11월 10일부터 적용합니다.
⑰ 제15조의3은 2021년 9월 30일부터 적용합니다.
제49조(이 약관에서 정하지 아니한 사항)
이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 관계법규 또는 일반 상관례에 따릅니다. 특히 단기카드대출(현금서비스), 장기카드대출(카드론) 등 여신 관련 사항에 대하여는 여신거래기본약관을 따르도록 합니다.
...
제 2 조 (연회비 등)
연회비 및 카드발급수수료는 회원에게 발급된 카드별로 달리 적용될 수 있으며 해당카드의 등급별, 종류별 금액은 은행이 정하는 바에 따릅니다.

제3조(재발급카드 등의 이용)
비씨카드(주)와 별도로 약정된 가맹점에서의 보험료, 통신요금의 결제 등 회원의 신청에 의한 계속적·반복적 거래계약의 처리를 위해 은행 또는 비씨카드(주)는 재발급된 카드번호를 이용할 수 있으며, 이를 가맹점에 제공할 수 있습니다. 단, 회원의 명시적인 거절의사가 있는 경우에는 그러하지 아니합니다.

제 4 조 (이용한도의 특례)
은행 또는 비씨카드(주)가 지정한 특정 승인건(통신요금, 보험료 등 자동이체청구, 철도·승차권 등 반환수수료 청구, 항공기 기내판매, 교통카드사용·청구 등)에 대해서는 이용한도에 관계 없이 무승인거래로 이용할 수 있습니다.

제5조(할부거래 및 분할납부)
① 회원은 표준약관 제11조제1항에서 지정한 가맹점에서 최저 5만원부터 할부구입이가능합니다.
② 회원은 1항의 가맹점에서 2회 분할납부를 이용할 수 있습니다.
③ 2회 분할납부 및 결제조건 변경에 의한 분할납부는 철회권 및 항변권 대상이 되지 않습니다.
제6조(이용대금 선결제 기한)
표준약관 제27조 제10항에 기한 선결제는 은행이 별도로 정하는 기한 이내에 가능합니다. 자세한 내용은 은행 홈페이지에서 확인할 수 있습니다.

제7조(타행출금이체)
① 회원은 은행의 결제일(휴일인 경우에는 익영업일)에 은행에서 청구하는 카드대금을 회원의 계좌에서 출금하여 납부하기로 합니다.
② 회원의 사정으로 출금이체의 결제계좌를 변경할 경우에 회원은 은행에 신청을 하여야 하고, 은행은 회원의 신청내용을 확인합니다. 만일 결제계좌 불일치로 인해 불능처리 된 경우의 손해에 대하여는 회원의 책임으로 합니다. 단, 본인의 고의 또는 과실이 없는 경우에는 제외합니다.
③ 출금이체를 위하여 지정계좌의 예금을 출금하는 경우에는 예금약관 또는 약정서의 규정에도 불구하고 예금청구서 또는 수표 없이 출금이체 처리절차에 의하여 출금하여도 이의가 없습니다.
④ 결제계좌가 자동대출약정이 있는 경우에는 대출한도까지 포함하여 출금이체하며, 지정출금일에 입금된 모든 수표는 제외합니다.
⑤ 결제일에 동일한 수종의 출금이체청구가 있을 경우 은행(결제계좌 개설기관)의 “자동계좌이체거래약관 등”에서 정한 출금 우선순위에 의하여 자동인출하여 결제합니다.
⑥ 출금이체 신규신청에 의한 이체개시일은 은행의 사정에 의하여 결정되며 은행으로부터 사전통지 받은 출금일을 최초 개시일로 합니다.
⑦ 출금이체 신청에 의한 결제계좌에서의 출금은 은행의 청구대로 출금하되, 청구금액에 이의가 있을 때에는 은행과 협의하여 조정해야 합니다.
제8조(취소매출의 청구)
할부 등 분할납부하는 매출건은 매출일로부터 은행이 별도로 정한 일정기간 이내에 취소하여야 해당 수수료를 환급받을 수 있습니다. 자세한 내용은 은행 홈페이지에서 확인할 수 있습니다.

제9조 (당연 기한이익의 상실)
회원은 제예치금 및 카드사에 제공한 담보 등에 대하여 압류, 경매, 기타 강제집행이 개시되었을 때 카드사는 서면으로 변제, 압류 등의 해소, 신용의 회복 등을 독촉하고 그 사유가 해소되지 않을 경우 카드사에 대한 모든 채무의 기한의 이익이 상실된다는 사실을 명시하여 통지하여야 합니다. 통지 도달일로부터 10일 이상으로 카드사가 정한 기간이 경과하면, 회원은 카드사에 대한 모든 채무의 기한의 이익을 상실하여 곧 이를 갚아야 할 의무를 집니다.

제 10 조 (상계)
제9조의 당연 기한이익의 상실, 카드이용대금의 변제기한 도래, 표준약관 제29조에 의한 기한이익의 상실 등을 사유로 회원이 은행에 대한 채무를 이행하여야 하는 경우에 은행은 회원이 부담하여야 하는 채무와 회원의 제예치금 및 기타 채권에 대해 지급정지 조치를 취한 후 서면통지에 의하여 상계할 수 있습니다.

제 11 조 (현금카드기능 이용)
① 회원은 은행 또는 은행이 인정하는 제휴기관의 계좌(현금카드기능 사용이 가능한 계좌에 한함)에 대해 현금카드 기능을 신청한 경우 국내 자동화기기 등에서 현금카드 기능을 사용할 수 있습니다.
② 현금카드 이용에 필요한 사항은 별도 약관으로 정합니다.